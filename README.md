...
| **`README.md §7.5–§7.12`**（本檔） ⭐⭐ | **v2.3 功能延伸：Argo Workflows CI/CD、Observability、Sealed Secrets、Per-user SIT、PVC Snapshot、Gherkin Editor** | 了解 v2.3 新功能 |
...
| 想了解 v2.3 新功能（Argo Workflows / Observability / Sealed Secrets） | **README.md §7.5–§7.12** |
