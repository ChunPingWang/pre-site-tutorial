...
| **`README.md §7.5–§7.13`**（本檔） ⭐⭐ | **功能延伸：Argo Workflows CI/CD、Observability、Sealed Secrets、Per-user SIT、PVC Snapshot、Gherkin Editor、Testcontainers 機制** | 了解 新功能 |
...
| 想了解 新功能（Argo Workflows / Observability / Sealed Secrets / Testcontainers） | **README.md §7.5–§7.13** |
